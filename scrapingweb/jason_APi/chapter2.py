...
from jason_APi.chapter3 import tweet
...
# you're going to do a bit of text analysis to count how many tweets contain ' \
# 'the words 'clinton', 'trump', 'sanders' and 'cruz'.' \
